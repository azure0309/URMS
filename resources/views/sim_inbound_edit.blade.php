    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    <div class="card-header">Sim Inbound Edit</div>
                    ...
                    <div class="card-body">
                        ...
                        @foreach($sim as $item)
                        <form action="/simregister/inbound/edit/done" method="get">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="agreement" value="{{$item['agreement']}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="post_pps" value="{{$item['post_pps']}}">
                            </div>
                            <div class="form-group">
