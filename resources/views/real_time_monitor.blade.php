  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-outline-danger btn-xs" data-dismiss="modal" id="alarm-status-save">Save</button>
      </div>
    </div>
  </div>
</div>
...
<div class="card">
    <div class="card-header">
      <div class="row">
        ...
        <div class="col">
          <a href="http://ucbs.uni/" target="_blank" class="btn btn-outline-primary btn-sm" role="button">A Cube</a>
        </div>
        <div class="col">
          <a href="https://globalroamer.com/webui/faces/login.xhtml?redirect=%2Fwebui%2Ffaces%2Fpages_site%2Ftestcases.xhtml%3Fid%3D7784409" target="_blank" class="btn btn-outline-primary btn-sm" role="button">SIGOS</a>
        </div>
      </div>
    </div>
    <div class="card-body">
...
$(function() {
    ...
    var today = new Date();
    var initst = today.getFullYear() +'/'+ (today.getMonth()-2) +'/'+(today.getDate()-3);
